...
import (
	...
	claudeprocessor "github.com/jaychinthrajah/claude-otel-collector/internal/claudeprocessor"
	contentfilter "github.com/jaychinthrajah/claude-otel-collector/internal/contentfilter"
...
func components() (otelcol.Factories, error) {
	...
	factories.ExporterModules[datadogexporter.NewFactory().Type()] = "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datadogexporter v0.115.0"
	...
	factories.Processors, err = processor.MakeFactoryMap(
		...
		claudeprocessor.NewFactory(),
		contentfilter.NewFactory(),
	)
	if err != nil {
		return otelcol.Factories{}, err
	}
	...
	factories.ProcessorModules[claudeprocessor.NewFactory().Type()] = "github.com/jaychinthrajah/claude-otel-collector/internal/claudeprocessor v0.0.0"
	factories.ProcessorModules[contentfilter.NewFactory().Type()] = "github.com/jaychinthrajah/claude-otel-collector/internal/contentfilter v0.0.0"
